...
This is a CCC weekly report with tables and plots of Connect recruitments: recruitment process, incentive, demographics, survey modules, biospecimen collections, refusal and withdrawals on `r format(Sys.Date()-1, '%d %B, %Y')` among the participants without inactive recruits.
...
recr_noinact_wl1 <- readRDS("~/Documents/CONNECT_projects/Biospecimen_Feb2022/Jing_projects/biospecQC_03082022/data/recruit2023-01-30.rds")
...
```{r,eval=TRUE,echo=FALSE,include=FALSE,fig.cap='Figure 1'}
knitr::opts_chunk$set(warning = FALSE, message = FALSE) 
#Figure 1. Number Verified Over Time
var.list <- c("token","Connect_ID","d_821247024","d_914594314","d_512820379","state_d_158291096","d_471593703","d_827220437","site")
...
Fig1_verified_time <- ggplot(veri_allsites,aes(y=Total.verified, x=as.Date(verified.week.date),color=site)) + geom_line() +    geom_point()+
 ...
 recrui.rate<-merge(recruit.site,response.site,by="d_827220437")
 
 verifed_expected <- melt(recrui.rate[,c("d_827220437","Expected","verified_site.x","Site","response.rate")],
 # ID variables - all the variables to keep but not split apart on
 id.vars=c("Site","d_827220437","response.rate"),
 # The source columns
 measure.vars=c("Expected","verified_site.x"),
 ...
 rateColor <- "orange" 
 Fig2a <- ggplot(verifed_expected,aes(x=Site))+
